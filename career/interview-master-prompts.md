...
| File | Sections |
|------|----------|
| [android-core.md](../android/android-core.md) | Lifecycle, components, views, threading, intents, services, IPC, Dagger, DSA stubs |
| [android-architecture.md](../android/android-architecture.md) | MVVM / MVP / MVI / Clean / DI / Compose / SOLID + Unit / UI / Espresso / Compose testing |
